...
public class ExtraCadastro {
	...
	public ExtraCadastro() {}

	// Contrutor com dados básicos para Visitante
	public ExtraCadastro(String nome, int idade) {
		this.nome = nome;
		this.idade = idade;
	}

	// Construtor com todos os dados para Aluno
	public ExtraCadastro(String nome, String profissao, int idade, String foto, String modalidade) {
		this.nome = nome;
